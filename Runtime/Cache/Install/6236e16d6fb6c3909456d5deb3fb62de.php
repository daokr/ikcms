...
<html>
    <head>
        <meta charset="utf-8">
        <title>开始安装IKPHP社区开源程序</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta name="description" content="">
        <meta name="author" content="">

        <!-- Le styles -->
        <link href="/ikcms/Public/static/bootstrap/css/bootstrap.css" rel="stylesheet">
        <link href="/ikcms/Public/static/bootstrap/css/bootstrap-responsive.css" rel="stylesheet">
        <link href="/ikcms/Public/Install/css/install.css" rel="stylesheet">

        <!-- Le HTML5 shim, for IE6-8 support of HTML5 elements -->
        <!--[if lt IE 9]>
            <script src="assets/js/html5shiv.js"></script>
        <![endif]-->
        <script src="/ikcms/Public/static/jquery-1.10.2.min.js"></script>
        <script src="/ikcms/Public/static/bootstrap/js/bootstrap.js"></script>
    </head>
 ...
 defined('SAE_MYSQL_HOST_M') or define('SAE_MYSQL_HOST_M', '127.0.0.1'); defined('SAE_MYSQL_HOST_M') or define('SAE_MYSQL_PORT', '3306'); ?>
    <h1>创建数据库</h1>
    <form action="/ikcms/install.php/Install/step2.html" method="post" target="_self">
        <div class="create-database">
            ...
            <div>
                ...
                <span>数据库连接类型，服务器支持的情况下建议使用mysqli &nbsp;&nbsp;<a href="http://cn2.php.net/manual/zh/book.mysqli.php" target="_blank">查看mysqli手册</a></span>
            </div>
            <div>
            ...
            <div>
                <input type="text" name="db[]" value="ik_">
